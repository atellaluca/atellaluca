...
- AWS serverless e managed services con confini infrastrutturali espliciti
...
Piattaforma full-stack per la gestione di veicoli aziendali, utenti, prenotazioni, viaggi, rifornimenti, manutenzioni, documenti e report.

- FastAPI backend e frontend React/TypeScript
- sviluppo locale con Docker Compose, DynamoDB Local e MinIO
...
- [Profilo tecnico](profile.md)
- [Casi studio](case-studies/index.md)
